...
export default function Sidebar() {
  ...
  return (
    <aside className="flex h-screen w-60 shrink-0 flex-col bg-slate-900 text-slate-200">
      {/* Logo — matches main frontend brand (teal gradient) */}
      <div className="flex h-16 items-center gap-3 px-5 border-b border-slate-700/60">
        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-teal-500 to-cyan-600 text-white shadow-lg">
          {/* Wrench icon — matches "Thợ Tốt" service theme */}
        ...
        <div>
          <p className="text-sm font-bold text-white leading-none tracking-tight">Thợ Tốt</p>
          <p className="text-xs text-teal-400 mt-0.5">Quản trị hệ thống</p>
        </div>
      </div>
