...
class PostsApi {
  ...
  Future<Response<PostResponseDto>> postControllerClosePost({ 
    required String id,
    ...
    final _path = r'/posts/{id}/close'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// * [cursor] - Cursor for pagination (ISO date)
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FeedResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FeedResponseDto>> postControllerGetFeed({ 
    num? limit,
    String? cursor,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    FeedResponseDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FeedResponseDto),
      ) as FeedResponseDto;
    ...
    return Response<FeedResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [FeedResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FeedResponseDto>> postControllerGetMyPosts({ 
    num? limit,
    String? cursor,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [PostResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PostResponseDto>> postControllerGetPostById({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
